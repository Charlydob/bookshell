...
function setEditModeUI(){
  ...
  if (mapWrap) mapWrap.style.display = (!isEditing || state.showEditLocationSearch) && state.addMode === "place" ? "" : "none";
}
