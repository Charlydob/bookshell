...
function openModal(stay = null) {
  ...
  modal.innerHTML = `<div class="world-stay-modal__backdrop" data-world-stay-close></div><section class="world-sheet world-stay-modal__sheet"><div class="world-sheet-header"><h3>${stay ? "Editar estancia" : "Añadir estancia"}</h3><button type="button" class="world-stay-close-x" data-world-stay-close aria-label="Cerrar">✕</button></div><div class="world-inline-2"><input data-world-stay-search placeholder="Buscar ciudad, país o dirección"><button type="button" class="world-optional-location-btn" data-world-use-current>Usar ubicación actual</button></div><div class="world-stay-search-results" data-world-stay-search-results hidden></div><div class="world-inline-2"><input data-world-stay-city placeholder="Ciudad"><input data-world-stay-region placeholder="Región"></div><div class="world-inline-2"><input data-world-stay-country placeholder="País"><input data-world-stay-flag placeholder="Bandera"></div><input data-world-stay-country-code hidden><div class="world-inline-2"><input type="date" data-world-stay-start><input type="date" data-world-stay-end></div><input inputmode="numeric" data-world-stay-total-days placeholder="Días totales"><button type="button" class="world-save" data-world-stay-save>Guardar</button></section>`;
